...
/***/ function(module, exports, __webpack_require__) {
	...
	var Chart = React.createClass({
	  ...
	  render: function () {
	    ...
	    var currentStyle = {
	      left: "calc(" + this.state.contribution / 6350 * 100 + "% - 39px)"
	    };
	    if (this.state.claims.length === 0) {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          'You have $',
	          leftToGo,
	          ' to spend before you reach your Deductible'
	        ),
	        React.createElement(
	          'div',
	          ...
	          React.createElement(
	            'div',
	            { className: 'current', style: currentStyle },
	            React.createElement(
	              'div',
	              ...
	              '$',
	              this.state.contribution.toFixed(2)
	            ),
	            React.createElement('div', { className: 'current-arrow' })
	          ),
	          React.createElement(
	            'div',
	            { className: 'deductible' },
	            React.createElement('div', { className: 'deductible-arrow' }),
	            React.createElement(
	              'div',
	          ...
	          React.createElement(
	            'div',
	            { className: 'max' },
	            React.createElement('div', { className: 'max-arrow' }),
	            React.createElement(
	              'div',
	              { className: 'max-text' },
	              'Out-of-Pocket ',
